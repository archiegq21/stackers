...
data class UserData(
    ...
    @SerialName("collectives") val collectives: List<CollectiveMembershipData> = emptyList(),
    ...
    @SerialName("last_access_date") val lastAccessDate: Long,
    @SerialName("last_modified_date") val lastModifiedDate: Long?,
    ...
    @SerialName("timed_penalty_date") val timedPenaltyDate: Long?,
